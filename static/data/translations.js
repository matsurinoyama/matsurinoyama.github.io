const TRANSLATIONS = {
  en: {
    ...
    resume: {
      ...
      sections: {
        ...
        installations: "Permanent / Semi-Permanent Installations",
  ...
  ja: {
    pageTitle: "茉莉の山",
    bio: "京都とシャーアラムを拠点に活動するマルチメディア作家。京都精華大学在学中。なお、サイトは現在も制作中なので、ご了承ください🏗️",
    nav: {
      works: "作品集",
      resume: "履歴書",
      lang: "EN",
    ...
    resume: {
      ...
      profileAlt: "プロフィール写真",
      overview: [
        '2001年マレーシア生まれ。幼少期をイギリスで過ごし、複数の言語・文化環境の中で育つ。一時期<a href="https://fskm.uitm.edu.my">Universiti Teknologi MARA, College of Computing, Informatics and Mathematics</a>に在学した後、現在は<a href="https://www.kyoto-seika.ac.jp/edu/media/">京都精華大学メディア表現学部</a>イメージ表現専攻に在学。スコットアレンゼミの「<a href="https://media.kyoto-seika.ac.jp/latentmedia/">Latent Media Lab.</a>」に所属。',
        "主に鑑賞者の身体的・社会的な参加によって成立する表現を探究し、インスタレーションを中心に制作。作品では、鑑賞者同士の対話や相互作用、さらには誤解やすれ違いといったコミュニケーションの不確かさに着目し、人の行動や関係性そのものを素材として扱う。作品を固定されたものとしてではなく、鑑賞者の参加によって状況が変化し続ける体験として捉え、他者との関係の中で立ち現れる共同的な経験のあり方を探っている。",
      ],
      sections: {
        exhibitions: "展 示 ・ 活 動 歴",
        group: "グループ展",
        awards: "受賞歴",
        scholarships: "奨学金",
        installations: "恒久・半恒久設置作品",
        work: "職 歴",
        education: "学 歴 ・ 資 格",
        diplomas: "学位・ディプロマ",
        qualifications: "資格・語学試験",
      },
    },
  },
};
