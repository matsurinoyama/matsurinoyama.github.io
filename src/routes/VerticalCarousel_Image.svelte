<script>
  ...
  function getImageHeight() {
    if (imageContainer_ID) {
      ...
      const imageSrc_Width = 50;
      const imageSrc_Height = imageSrc_Width * aspectRatio;
  ...
  onMount(getImageHeight);
  afterUpdate(getImageHeight);
</script>

<div
  class="imageContainer"
  class:isExpanded
  style="--pos-x: {image.posX}; --pos-y: {image.posY}; --img-height: {imageContainer_Height}vw; --img-width: {imageContainer_Width}vw;"
